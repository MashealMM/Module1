...
(function(C) {
        ...
        for (var c = a.$$hashKey, e = 0, f = b.length; e < f; ++e) {
            ...
            if (D(g) || z(g))
                for (var h = Object.keys(g), k = 0, l = h.length; k < l; k++) {
                    var m = h[k]
                      , n = g[m];
                    d && D(n) ? da(n) ? a[m] = new Date(n.valueOf()) : Wa(n) ? a[m] = new RegExp(n) : n.nodeName ? a[m] = n.cloneNode(!0) : Qb(n) ? a[m] = n.clone() : (D(a[m]) || (a[m] = L(n) ? [] : {}),
                    Pb(a[m], [n], !0)) : a[m] = n
                }
        }
    ...
    function pa(a, b) {
        ...
        function c(a) {
            ...
            var b = !1
              , c = e(a);
            void 0 === c && (c = L(a) ? [] : Object.create(wc(a)),
            b = !0);
            f.push(a);
            g.push(c);
            return b ? d(a, c) : c
    ...
    function na(a, b) {
        ...
        if (d == typeof b && "object" == d)
            if (L(a)) {
                ...
                if (da(a))
                    return da(b) ? na(a.getTime(), b.getTime()) : !1;
                if (Wa(a))
    ...
    function bb(a, b) {
        if (!y(a))
            return T(b) || (b = b ? 2 : null),
            JSON.stringify(a, ce, b)
    }
    function xc(a) {
    ...
    function Ac(a) {
        ...
        q((a || "").split("&"), function(a) {
            ...
            e = zc(e),
            w(e) && (f = w(f) ? zc(f) : !0,
            ua.call(b, e) ? L(b[e]) ? b[e].push(f) : b[e] = [b[e], f] : b[e] = f))
        });
        return b
    }
    function Tb(a) {
    ...
    function je() {
        ...
        if (!Dc) {
            var b = rb();
            (qa = y(b) ? C.jQuery : b ? C[b] : void 0) && qa.fn.on ? (F = qa,
            S(qa.fn, {
                scope: Oa.scope,
        ...
        if (f)
            if (b) {
                var g = function(b) {
                    var c = e[b];
                    w(d) && Za(c || [], d);
                    w(d) && c && 0 < c.length || (a.removeEventListener(b, f, !1),
                    delete e[b])
                };
            ...
            q(a, function(a) {
                ...
                if (!m.get(a)) {
                    ...
                    try {
                        ...
                        d(c._invokeQueue),
                        d(c._configBlocks)) : z(a) ? b.push(p.invoke(a)) : L(a) ? b.push(p.invoke(a)) : Pa(a, "module")
                    } catch (e) {
        ...
        this.$get = ["$window", "$location", "$rootScope", function(b, d, c) {
            ...
            function f(a) {
                if (a) {
                    ...
                    c = g.yOffset;
                    z(c) ? c = c() : Qb(c) ? (c = c[0],
                    c = "fixed" !== b.getComputedStyle(c).position ? 0 : c.getBoundingClientRect().bottom) : T(c) || (c = 0);
    ...
    function $f(a, b, d, c) {
        ...
        k.url = function(b, d, e) {
            ...
            if (b) {
                ...
                e = -1 === e ? "" : b.substr(e),
                d.hash = e) : l.href = b,
                l.href !== b && (t = b)) : (m[d ? "replaceState" : "pushState"](e, "", b),
                g(),
                J = r);
                t && (t = b);
                return k
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$sce", "$animate", "$$sanitizeUri", function(a, b, c, e, n, t, K, M, H, E) {
            ...
            function s(a, b, c, d, e, f) {
                function g(a, c, d, e) {
                    ...
                    for (p = h.length; m < p; )
                        ...
                        f = h[m++],
                        c ? (c.scope ? (l = a.$new(),
                        aa.$$addScopeInfo(F(k), l)) : l = a,
                        r = c.transcludeOnThisElement ? za(a, c.transclude, e) : !c.templateOnThisElement && e ? e : !e && b ? za(a, b) : null,
                        c(f, l, k, d, r)) : f && f(a, k.childNodes, void 0, e)
                }
            ...
            function $b(a, b, c, d, e) {
                ...
                case 1:
                    ...
                    for (var g, k, l, m, p = a.attributes, n = 0, r = p && p.length; n < r; n++) {
                        ...
                        g = Aa(k);
                        if (m = Ba.test(g))
                            k = k.replace(Yc, "").substr(8).replace(/_(.)/g, function(a, b) {
                                return b.toUpperCase()
                            });
                        (g = g.match(Ca)) && V(g[1]) && (v = k,
            ...
            function oa(a, b, d, e, f, g, h, k, l) {
                ...
                function p(a, e, f, g, l) {
                    ...
                    u && (aa.$$addScopeInfo(I, M, !0, !(H && (H === u || H === u.$$originalDirective))),
                    ...
                    for (E = h.length; n < E; n++)
                        x = h[n],
                        la(x, x.isolateScope ? M : e, I, g, x.require && ib(x.directiveName, x.require, I, t), P);
                    var s = e;
                ...
                for (var n = -Number.MAX_VALUE, r = l.newScopeDirective, v = l.controllerDirectives, u = l.newIsolateScopeDirective, H = l.templateDirective, E = l.nonTlbTranscludeDirective, M = !1, B = !1, fa = l.hasElementTranscludeDirective, t = d.$$element = F(b), x, I, P, K = e, s, Fa = !1, za = !1, w, A = 0, C = a.length; A < C; A++) {
                    ...
                    if (n > x.priority)
                        break;
                    if (w = x.scope)
                        x.templateUrl || (D(w) ? (X("new/isolated scope", u || r, x, t),
                        u = x) : X("new/isolated scope", u, x, t)),
                        r = r || x;
                    I = x.name;
                    ...
                    !x.templateUrl && x.controller && (w = x.controller,
                    v = v || U(),
                    X("'" + I + "' controller", v[I], x, t),
                    v[I] = x);
                    if (w = x.transclude)
                        if (M = !0,
                        x.$$tlb || (X("transclusion", E, x, t),
                        E = x),
                        "element" == w)
                            fa = !0,
                            n = x.priority,
                    ...
                    x.terminal && (p.terminal = !0,
                    n = Math.max(n, x.priority))
                }
                p.scope = r && !0 === r.scope;
                        ...
                        try {
                            ...
                            (y(h) || h > p.priority) && -1 != p.restrict.indexOf(g)) {
                                ...
                                if (!p.$$bindings) {
                                    ...
                                    D(v.scope) && (!0 === v.bindToController ? (H.bindToController = d(v.scope, x, !0),
                                    H.isolateScope = {}) : H.isolateScope = d(v.scope, x, !1));
            ...
            function ba(a, b, c, d, f, g, h, k) {
                ...
                return function(a, b, c, d, e) {
                    a = e;
                    b.$$destroyed || (l ? l.push(b, c, d, a) : (m.transcludeOnThisElement && (a = za(b, m.transclude, e)),
                    m(p, b, c, d, a)))
                }
            }
            function Z(a, b) {
            ...
            function X(a, b, c, d) {
                ...
                if (b)
                    throw ga("multidir", b.name, e(b.$$moduleName), c.name, e(c.$$moduleName), a, ya(d));
            }
            function ca(a, c) {
                var d = b(c, !0);
                d && a.push({
            ...
            function ka(a, c, d, e, f) {
                function g(b, c, e) {
                    z(d.$onChanges) && c !== e && (Y || (a.$$postDigest(I),
                    Y = []),
                    m || (m = {},
                    Y.push(h)),
    ...
    function ff() {
        ...
        this.$get = ["$injector", "$window", function(d, c) {
            ...
            return function(f, g, h, k) {
                ...
                if (h)
                    return h = (L(f) ? f[f.length - 1] : f).prototype,
    ...
    function mf() {
        ...
        this.$get = ["$httpBackend", "$$cookieReader", "$cacheFactory", "$rootScope", "$q", "$injector", function(e, f, g, h, k, l) {
            ...
            function n(c, d) {
                ...
                E && (I = E.get(P),
                w(I) ? I && z(I.then) ? I.then(t, t) : L(I) ? n(I[1], I[0], ia(I[2]), I[3]) : n(I, 200, {}, "OK") : E.put(P, H));
                y(I) && ((I = id(c.url) ? f()[c.xsrfCookieName || a.xsrfCookieName] : void 0) && (Da[c.xsrfHeaderName || a.xsrfHeaderName] = I),
                e(c.method, P, d, l, Da, c.timeout, c.withCredentials, c.responseType, g(c.eventHandlers), g(c.uploadEventHandlers)));
                return H
            }
            function p(a, b) {
    ...
    function gc(a, b, d) {
        ...
        this.$$parseLinkUrl = function(c, e) {
            ...
            var f, g;
            w(f = ka(a, c)) ? (g = f,
            g = w(f = ka(d, f)) ? b + (ka("/", f) || f) : a + g) : w(f = ka(b, c)) ? g = b + f : b == c + "/" && (g = b);
            g && this.$$parse(g);
            return !!g
        }
    }
    ...
    function sf() {
        ...
        this.html5Mode = function(a) {
            return Ga(a) ? (b.enabled = a,
            this) : D(a) ? (Ga(a.enabled) && (b.enabled = a.enabled),
        ...
        this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", "$window", function(d, c, e, f, g) {
            ...
            f.on("click", function(a) {
                if (b.rewriteLinks && !a.ctrlKey && !a.metaKey && !a.shiftKey && 2 != a.which && 2 != a.button) {
                    ...
                    R.test(h) || !h || e.attr("target") || a.isDefaultPrevented() || !l.$$parseLinkUrl(h, k) || (a.preventDefault(),
        ...
        S(f.prototype, {
            ...
            $$resolve: function(a) {
                ...
                try {
                    if (D(a) || z(a))
                        g = a && a.then;
                    z(g) ? (this.promise.$$state.status = -1,
    ...
    function vf() {
        ...
        this.$get = ["$exceptionHandler", "$parse", "$browser", function(f, g, h) {
            ...
            function l(a) {
                9 === Ea && (a.$$childHead && l(a.$$childHead),
            ...
            m.prototype = {
                ...
                $digest: function() {
                    ...
                    n("$digest");
                    h.$$checkUrlChange();
                    this === J && null !== e && (h.defer.cancel(e),
                    B());
                    c = null;
                    do {
                        r = !1;
                            ...
                            if (p = t.$$watchers)
                                for (u = p.length; u--; )
                                    try {
                                        if (a = p[u])
                                            if (m = a.get,
                                            (g = m(t)) !== (k = a.last) && !(a.eq ? na(g, k) : "number" === typeof g && "number" === typeof k && isNaN(g) && isNaN(k)))
                                                r = !0,
                                                c = a,
        ...
        this.$get = ["$templateCache", "$http", "$q", "$sce", function(b, d, c, e) {
            function f(g, h) {
                ...
                return d.get(g, S({
                    ...
                    if (!h)
                        throw pg("tpload", g, a.status, a.statusText);
                    return c.reject(a)
                })
            }
    ...
    function Dd(a) {
        ...
        function c(a, b) {
            ...
            if (d === k) {
                ...
                l = l.toLowerCase()) : "object" === d && (D(k) && (k = a.index),
                D(l) && (l = b.index));
                k !== l && (c = k < l ? -1 : 1)
            } else
                c = d < k ? -1 : 1;
    ...
    var Uf = C.Node.prototype.contains || function(a) {
      ...
      , Oa = O.prototype = {
        ready: function(a) {
            ...
            var d = !1;
            "complete" === C.document.readyState ? C.setTimeout(b) : (this.on("DOMContentLoaded", b),
            O(C).on("load", b))
        },
        toString: function() {
            var a = [];
            ...
            if (c !== Ma && 2 !== c && 8 !== c)
                ...
                Eb[c])
                    if (w(d))
                        ...
                        return a[b] || (a.attributes.getNamedItem(b) || A).specified ? c : void 0;
                else if (w(d))
                    a.setAttribute(b, d);
        ...
        readString: function(a) {
            ...
            for (var d = "", c = a, e = !1; this.index < this.text.length; ) {
                ...
                if (e)
                    ...
                    this.index += 4,
                    d += String.fromCharCode(parseInt(e, 16))) : d += Jg[f] || f,
                    e = !1;
                else if ("\\" === f)
                    e = !0;
                else {
            ...
            if (!f && w(a.watchId))
                ...
                case s.ObjectExpression:
                    ...
                    q(a.properties, function(a) {
                        ...
                        k.recurse(a.key, g)) : g = a.key.type === s.Identifier ? a.key.name : "" + a.key.value;
                        h = k.nextId();
                        k.recurse(a.value, h);
    ...
    ud.prototype = {
        ...
        recurse: function(a, b, d) {
            ...
            case s.Identifier:
                return Sa(a.name, f.expression),
                f.identifier(a.name, f.expensiveChecks || Jb(a.name), b, d, f.expression);
            case s.MemberExpression:
                return c = this.recurse(a.object, !1, !!d),
                a.computed || (Sa(a.property.name, f.expression),
                e = a.property.name),
            ...
            return {
                ...
                link: function(d, c, e) {
                    ...
                    e.$observe(b, function(b) {
                        b ? (e.$set(g, b),
                        Ea && f && c.prop(f, e[g])) : "href" === a && e.$set(g, null)
                    })
                }
            }
        }
    ...
    var Ee = ["$animate", "$compile", function(a, b) {
            ...
            compile: function(c, e) {
                ...
                return function(c, e, m, n, p) {
                    ...
                    c.$watch(f, function(f) {
                        ...
                        c.$emit("$includeContentRequested", f)) : (y(),
                        n.template = null)
                    })
                }
            }
      ...
      , We = ["$compile", function(a) {
        return {
            ...
            link: function(b, d, c, e) {
                ...
                a(Oc(e.template, C.document).childNodes)(b, function(a) {
                    d.append(a)
                }, {
      ...
      , Pg = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout", "$rootScope", "$q", "$interpolate", function(a, b, d, c, e, f, g, h, k, l) {
        ...
        this.$$runValidators = function(a, b, c) {
            ...
            (function() {
                ...
                if (y(B))
                    ...
                    return B || (q(r.$validators, function(a, b) {
                        f(b, null)
                    }),
        ...
        this.$$debounceViewValueCommit = function(b) {
            var c = 0
              , d = r.$options;
            d && w(d.debounce) && (d = d.debounce,
            T(d) ? c = d : T(d[b]) ? c = d[b] : T(d["default"]) && (c = d["default"]));
            g.cancel(s);
            c ? s = g(function() {
                r.$commitViewValue()
      ...
      , Ve = function() {
        return {
            ...
            controller: ["$scope", "$attrs", function(a, b) {
                ...
                this.$options.updateOn = W(this.$options.updateOn.replace(Qg, function() {
            ...
            link: {
                ...
                post: function(d, h, k, l) {
                    ...
                    function n() {
                        ...
                        h[0].appendChild(C);
                        s.$render();
                        s.$isEmpty(a) || (b = p.readValue(),
                        (K.trackBy || y ? na(a, b) : a === b) || (s.$setViewValue(b),
                        s.$render()))
                    }
                    ...
                    K.trackBy && d.$watchCollection(function() {
                        ...
                        b ? (h[0].value !== b.selectValue && (z.remove(),
                        v || B.remove(),
                        h[0].value = b.selectValue,
                        b.element.selected = !0),
                        b.element.setAttribute("selected", "selected")) : null === a || v ? (z.remove(),
                        v || h.prepend(B),
                        h.val(""),
                        B.prop("selected", !0),
                        B.attr("selected", !0)) : (v || B.remove(),
                        h.prepend(z),
                        h.val("?"),
                        z.prop("selected", !0),
                        z.attr("selected", !0))
                    ...
                    p.readValue = function() {
                        ...
                        return a && !a.disabled ? (v || B.remove(),
                        z.remove(),
                    ...
                    v ? (B.remove(),
                    a(B)(d),
                    B.removeClass("ng-scope")) : B = F(e.cloneNode(!1));
                    h.empty();
                    n();
        ...
        return {
            link: function(f, g, h) {
                ...
                f.$watch(l, function(b) {
                    ...
                    c === v || e && T(v) && isNaN(v) || (z(),
                    e = s[c],
                    y(e) ? (null != b && d.debug("ngPluralize: no rule defined for '" + c + "' in " + m),
                    z = A,
                    k()) : z = f.$watch(e, k),
                    v = c)
                })
    ...
    C.angular.bootstrap ? C.console && console.log("WARNING: Tried to load angular more than once.") : (je(),
    le(ca),
